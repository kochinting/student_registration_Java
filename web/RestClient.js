...
// Model for Students entity
    models.Students = Backbone.Model.extend({
        urlRoot: "http://localhost:8080/StudentRegistrationFinal/webresources/students/",
        ...
        sync: function (method, model, options) {
            ...
            if (method === 'create') {
                options.url = 'http://localhost:8080/StudentRegistrationFinal/webresources/students/';
            }
    ...
    // Collection class for StudentsCourses entities
    models.StudentsCollection = Backbone.Collection.extend({
        model: models.Students,
        url: "http://localhost:8080/StudentRegistrationFinal/webresources/students/",
        sync: function (method, model, options) {
            options || (options = {});
            var errorHandler = {
                error: function (jqXHR, textStatus, errorThrown) {
